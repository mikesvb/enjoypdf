...
public class MainController {
	...
	@FXML
	private Button clearButton, mergeButton, selectButton1, selectButton2, selectButton3, goSeparateButton;

	@FXML
	private TextField link1, link2, link3, newNameMergeFile;
	...
	// merge
	// https://coderlessons.com/tutorials/java-tekhnologii/vyuchit-pdfbox/pdfbox-obedinenie-neskolkikh-dokumentov-pdf
	...
	public void mergeAction() throws IOException {
		...
		if (newNameMergeFile.getText().equals("")) {
			fileName = "merged.pdf";
		} else {
			fileName = newNameMergeFile.getText() + ".pdf";
		}

		String newfile = link3.getText() + "\\" + fileName;
	...
	public void goSeparateAction() throws IOException {
		App.status = 3;

		String fxmlFile = "/fxml/separate.fxml";
		FXMLLoader loader = new FXMLLoader();
		Parent root = (Parent) loader.load(getClass().getResourceAsStream(fxmlFile));
		App.mainStage.setTitle("Объединение PDF - Разделить файл на куски");
		App.mainStage.setScene(new Scene(root));
		App.mainStage.setResizable(false);
